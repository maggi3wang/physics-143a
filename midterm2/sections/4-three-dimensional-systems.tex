...
Find sols to angular eqn. Sep of vars $Y(\theta, \phi) = \Theta(\theta) \Phi(\phi)$.
...
$\widehat{\vec{J}}^2 ( \widehat{J}_{\pm} | ab \rangle) = a(\widehat{J}_{\pm} | ab \rangle$, so $\widehat{J}_{\pm} | ab \rangle \qquad$
